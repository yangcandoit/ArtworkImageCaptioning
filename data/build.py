...
from .iconclass_classify import Iconclass
...
def load_dataset(config):
    ...
    return dataset_train, dataset_val, data_loader_train, data_loader_val,dataset_train.mlb

    
def build_dataset(mode, config):
    transform = build_transform(mode, config)        
    dataset=Iconclass(config.DATA.DATA_PATH,mode,transform)
...
def build_transform(mode, config):
