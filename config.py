...
# -----------------------------------------------------------------------------
_C.MODEL = CN()
# Encoder backbone type
_C.MODEL.ENCODER = 'swin'
# Decoder network type
_C.MODEL.DECODER = 'MeshedNet'

_C.MODEL.TYPE=''
# Model name
_C.MODEL.NAME = 'meshed_swin'
...
#Meshed Net parameters

_C.MODEL.MESH = CN()
_C.MODEL.MESH.NUM_VERTICES = [3, 3, 3, 3] 
...
def get_config(args):
    ...
    # Return a clone so that the defaults will novaluest be altered
